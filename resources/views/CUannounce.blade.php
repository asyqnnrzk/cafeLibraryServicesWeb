...
<head>
    ...
    <title>Create or Update Page for Announcement</title>
</head>
<body>
    <header>
        <h1 >Create or Update for Announcement <button style="float: right">Profile</button></h1>
    </header>
    <main>
        <div class="container">
            <button>Back</button>
                ...
                <div id="form-container">
                    <table>
                        ...
                        <tr>
                            <td>Title:</td>
                            <td>
                                <input type="text" name="title" placeholder="24H Opening!">
                            </td>
                        </tr>
                        <tr>
                            <td>Content:</td>
                            <td>
                                <input type="text" name="content" placeholder="The library will be opening for 24 hours starting from today!">
                            </td>
                        </tr>
                    </table>
                </div>
