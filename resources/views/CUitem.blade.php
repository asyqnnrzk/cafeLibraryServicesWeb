...
<head>
    ...
    <title>Create or Update Page for Item</title>
</head>
<body>
    <header>
        <h1 >Create or Update for Item <button style="float: right">Profile</button></h1>
    </header>
    <main>
        <div class="container">
            <button>Back</button>
                ...
                <div id="form-container">
                    <table>
                        <tr>
                            <td>Name:</td>
                            <td>
                                <input type="text" name="name" placeholder="eg: Room, Book">
                            </td>
                        </tr>
                        <tr>
                            <td>Library ID:</td>
